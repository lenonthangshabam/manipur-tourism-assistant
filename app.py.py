...
def transcribe_audio(uploaded_audio, language: str):
    ...
    try:
        ...
        speech_code = {"English": "en-IN", "Hindi": "hi-IN"}.get(language, "en-IN")
        ...
        return None, f"Speech recognition service is unavailable right now. Details: {exc}"
...
with st.sidebar:
    ...
    st.caption("Manipuri text mode uses an online translation layer with tourism-specific fallbacks. Voice input is currently English/Hindi only.")
